		  ...
		  <div class="col-lg-offset-3 col-lg-6">
		    <div class="input-group">
		      ...
		      <span class="input-group-btn">
		        <button class="btn btn-default" type="button" id="search-btn" onclick="search();">Buscar</button>
		      </span>
		    </div>
		    <a class="pull-left" role="button" href="#" id="all-list-btn" onclick="allList();"><i class="fa fa-list"></i> Todos</a>
		    <a class="pull-right" role="button" href="#" id="all-list-btn" data-toggle="modal" data-target="#newModal"><i class="fa fa-plus"></i> Agregar Nuevo</a>		    
		  </div>
		</div>
		<hr>
		<div class="row">
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title" id="newModalLabel">Nuevo</h4>
	      </div>
